...
class dataset:
    def __init__(self):
        self.root = r"C:/Users/ddzam/Downloads/TrabajoDeGrado/Dataset/part_A/train_data/images/"
    ...
    def makeDataset(self):
        ...
        self.datasetTrain = open("trainDensas.json", "w")  # Crea un archivo .json para almacenar los archivos para el dataset de entrenamiento.
        ...
        self.datasetValidation = open("valDensas.json", "w")  # Crea un archivo .json para almacenar los archivos para el dataset de validación.
