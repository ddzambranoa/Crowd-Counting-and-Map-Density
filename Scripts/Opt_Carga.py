...
from PyQt5.QtWidgets import QLabel, QProgressBar, QFrame, QWidget, QVBoxLayout, QGraphicsDropShadowEffect, QMainWindow

from Scripts.InterfazPrincipal import MainWindow

counter = 0


class iniciarPrograma(QMainWindow):
    def __init__(self):
        ...
        QtCore.QTimer.singleShot(1500,
                                 lambda: self.ui.label_description.setText("<strong>CARGANDO</strong> BASE DE DATOS"))
...
class ui_splashscreen(object):
    ...
    def retranslateUi(self, SplashScreenI):
        ...
        self.label_title.setText(
            QCoreApplication.translate("SplashScreen", u"<strong>ESTIMACIÓN DE DENSIDAD DE PERSONAS</strong>", None))
        ...
        self.label_credits.setText(
            QCoreApplication.translate("SplashScreen", u"<strong>Creador:</strong> Daniel Zambrano A.", None))
